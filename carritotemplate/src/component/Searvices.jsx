  ...
  return (
     ...
     <div className="container-fluid px-0">
        <div className="row g-0">
            <div className="col-6 col-md-4 col-lg-2 border-start border-end wow animate__animated animate__bounceIn" data-wow-delay="0.1s">
            <div className="p-4">
            ...
            <div className="col-6 col-md-4 col-lg-2 border-end wow animate__animated animate__fadeOutDownBig" data-wow-delay="0.2s">
            <div className="p-4">
            ...
            <div className="col-6 col-md-4 col-lg-2 border-end wow animate__animated animate__fadeInUp" data-wow-delay="0.3s">
            <div className="p-4">
                <div className="d-flex align-items-center">
            ...
            <div className="col-6 col-md-4 col-lg-2 border-end wow animate__animated animate__flipInY" data-wow-delay="0.4s">
            <div className="p-4">
                <div className="d-flex align-items-center">
            ...
            <div className="col-6 col-md-4 col-lg-2 border-end wow animate__animated animate__fadeInUp" data-wow-delay="0.5s">
            <div className="p-4">
                <div className="d-flex align-items-center">
            ...
            <div className="col-6 col-md-4 col-lg-2 border-end wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
            <div className="p-4">
                <div className="d-flex align-items-center">
